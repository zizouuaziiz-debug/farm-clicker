...
function GrowthProgressRing({
  ...
  return (
    <svg
      ...
      height="44"
      viewBox="0 0 44 44"
      className="absolute -top-1 -right-1 drop-shadow-lg z-20"
    >
      <circle
        cx="22"
        cy="22"
      ...
      harvestPlot.mutate(
        { plotId: plot.id },
        {
          onSuccess: (data) => {
            ...
            toast.success(
              `Harvested ${data.quantity} ${CROP_EMOJIS[data.cropType] ?? "🌱"} +${data.coinsEarned}🪙`
            );
          },
              ...
              <div className="bg-card rounded-2xl border p-5 shadow-2xl">
                ...
                {availableSeeds.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <GameButton onClick={() => (window.location.href = "/shop")}>
                      Go Shop
                    </GameButton>
                  </div>
                ) : (
